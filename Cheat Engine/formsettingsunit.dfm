    ...
    object pcSetting: TPageControl
      ...
      object GeneralSettings: TTabSheet
        ...
        object cbCenterOnPopup: TCheckBox
          ...
          Width = 601
          Height = 21
          Caption = 'Center ............ when bringing to front'
          Checked = True
          State = cbChecked
          TabOrder = 2
        end
        object EditUpdateInterval: TEdit
          ...
          Height = 24
          Hint = 
            'The number of milliseconds that ............ will wait before re' +
        ...
        object cbHideAllWindows: TCheckBox
          ...
          Height = 21
          Caption = 
            'Hide some/all windows instead of trying to bring ............ to' +
            ' front'
          Checked = True
          State = cbChecked
          TabOrder = 9
      ...
      object CodeFinder: TTabSheet
        ...
        object Label4: TLabel
          ...
          Align = alTop
          Caption = 
            'There are 2 ways ............ can find the addresss of code that' +
