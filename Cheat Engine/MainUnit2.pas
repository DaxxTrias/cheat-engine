    ...
    try
      ...
      begin
        ...
        begin
          ...
          if reg.ValueExists('Show ............ Hotkey') then
            reg.ReadBinaryData('Show ............ Hotkey',temphotkeylist[0][0],10) else  mainform.label7.Caption:='';
      ...
      if Reg.OpenKey('\Software\............\Tools',false) then
      begin
      ...
      if (not skipPlugins) and (Reg.OpenKey('\Software\............\Plugins'{$ifdef cpu64}+'64'{$else}+'32'{$endif},false)) then
      begin
        names:=TStringList.create;
        try
          reg.GetValueNames(names);
