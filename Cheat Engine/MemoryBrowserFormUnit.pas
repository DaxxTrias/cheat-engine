...
begin
  ...
  try
    ...
    if reg.OpenKey('\Software\............\Disassemblerview\Font',true) then
      SaveFontToRegistry(disassemblerview.font, reg);

    if reg.OpenKey('\Software\............\Hexview\Font',true) then
...
begin
  ...
  try
    ...
    if reg.OpenKey('\Software\............\Disassemblerview\Font',false) then
    begin
    ...
    if reg.OpenKey('\Software\............\Hexview\Font',false) then
    begin
      LoadFontFromRegistry(f, reg);
      hexview.hexfont:=f;
    end;
