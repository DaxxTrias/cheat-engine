...
//        attaching:=false;
        ...
        err:='............ failed to create the process. (Error='+pchar(IntToStr(GetLastError))+')';
        messagebox(0,pchar(err),'Create failure',mb_ok);
  ...
  //    }
      ...
      begin
        ...
        {$ifndef net}
        err:='............ failed to attach to the process. (Error='+IntToStr(GetLastError)+')';
        ...
        case devent.dwDebugEventCode of
          ...
          begin
            ...
            begin
              ...
              begin
                //check if this is a exception breakpoint that was made by ............
                      ...
                      try
                        ...
                        begin
                          ...
                          begin
                            ...
                            j:=devent.dwThreadId;
                            if not WaitForDebugEvent(devent,10000) then application.MessageBox('userbreakpoint bug','............ Debugger',0);
