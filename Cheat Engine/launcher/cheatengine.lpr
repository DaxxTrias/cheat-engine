...
begin
  ...
  begin
    if fileexists(selfpath+'cheatengine-i386.exe') then
      ...
      MessageBox(0, 'cheatengine-i386.exe could not be found. Please disable/uninstall your anti virus and reinstall ............ to fix this','............ launch error',MB_OK or MB_ICONERROR);
  end
  else
  begin
    if FileExists(selfpath+'cheatengine-x86_64.exe') then
      ...
      MessageBox(0, 'cheatengine-x86_64.exe could not be found. Please disable/uninstall your anti virus and reinstall ............ to fix this','............ launch error',MB_OK or MB_ICONERROR);
  end;
