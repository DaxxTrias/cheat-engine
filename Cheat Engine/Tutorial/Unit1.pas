...
resourcestring
  ...
  rsTutorial1='Welcome to the ............ Tutorial. (v3.2)'+#13#10+
              ...
              ''+#13#10+
              'First open ............ if it hasn''t been opened yet.'+#13#10+
...
{  //search for ............
  ...
  begin
    ...
    begin
      ...
      if (uppercase(processname)='............ SERVER.EXE') or (uppercase(processname)='CESERVER.EXE') or (uppercase(processname)='CHEATENGINE.EXE') or (uppercase(processname)='.............EXE') then
      begin
